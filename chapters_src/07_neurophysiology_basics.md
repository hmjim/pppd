...
### Домашнее задание (ДЗ):
1.  Внедри **утренний протокол**: контрастный душ → 10 минут медитации (по технике из [Главы 47](47_meditation.html)) → завтрак. Выполняй его 7 дней подряд без пропусков. Фиксируй в дневнике уровень шаткости утром (до протокола) и через 30 минут (после).
