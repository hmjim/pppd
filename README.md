...
<p align="center">
  <img src="https://img.shields.io/badge/Глав-30-6366f1" alt="30 глав">
  <img src="https://img.shields.io/badge/Модулей-5-10b981" alt="5 модулей">
  <img src="https://img.shields.io/badge/Бесплатных-10-f59e0b" alt="10 бесплатных">
...
Это не теоретическая монография. Это **инженерная инструкция** из 30 глав и 5 модулей, построенная на доказательных терапевтических протоколах.
...
| 2 | **Батарейка** | Адреналиновая петля, CAS, ипохондрия, экспозиция, спорт, дереализация | 🔒 По ключу |
...
Первые **10 глав бесплатны** — без регистрации и без ограничений.
